        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryAssettId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CheckoutHistories_LibraryAssets_LibraryAssettId",
                        column: x => x.LibraryAssettId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Checkouts_LibraryAssets_LibraryAssettId",
                        column: x => x.LibraryAssettId,
                        principalTable: "LibraryAssets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryAssettId = table.Column<int>(nullable: true),
                    LibraryCardId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Holds_LibraryAssets_LibraryAssettId",
                        column: x => x.LibraryAssettId,
                        principalTable: "LibraryAssets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckoutHistories_LibraryAssettId",
                table: "CheckoutHistories",
                column: "LibraryAssettId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Checkouts_LibraryAssettId",
                table: "Checkouts",
                column: "LibraryAssettId");
